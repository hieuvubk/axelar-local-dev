...
export interface AxelarGatewayInterface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "approveContractCall",
    values: [PromiseOrValue<BytesLike>, PromiseOrValue<BytesLike>]
  ): string;
  encodeFunctionData(
    functionFragment: "approveContractCallWithMint",
    values: [PromiseOrValue<BytesLike>, PromiseOrValue<BytesLike>]
  ): string;
  encodeFunctionData(
...
export interface AxelarGateway extends BaseContract {
  ...
  functions: {
    ...
    transferMintLimiter(
      newMintLimiter: PromiseOrValue<string>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;

    transferOperatorship(
      newOperatorsData: PromiseOrValue<BytesLike>,
      arg1: PromiseOrValue<BytesLike>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
