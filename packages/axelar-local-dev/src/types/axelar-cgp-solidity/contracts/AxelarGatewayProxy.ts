...
export interface AxelarGatewayProxyInterface extends utils.Interface {
  functions: {
...
export interface AxelarGatewayProxy extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: AxelarGatewayProxyInterface;
