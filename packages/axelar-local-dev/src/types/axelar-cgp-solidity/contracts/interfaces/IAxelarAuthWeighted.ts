...
export interface IAxelarAuthWeightedInterface extends utils.Interface {
  functions: {
  ...
  encodeFunctionData(
    functionFragment: "epochForHash",
    values: [PromiseOrValue<BytesLike>]
  ): string;
  encodeFunctionData(
    functionFragment: "hashForEpoch",
...
export interface IAxelarAuthWeighted extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IAxelarAuthWeightedInterface;
  ...
  filters: {
    "OperatorshipTransferred(address[],uint256[],uint256)"(
      newOperators?: null,
      newWeights?: null,
      newThreshold?: null
