...
export declare namespace IInterchainGasEstimation {
...
export interface AxelarGasServiceInterface extends utils.Interface {
  functions: {
    ...
    "updateGasInfo(string[],(uint8,uint128,uint128,uint128,uint128)[])": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "refund(bytes32,uint256,address,address,uint256)",
    values: [
      PromiseOrValue<BytesLike>,
      PromiseOrValue<BigNumberish>,
      PromiseOrValue<string>,
  ...
  encodeFunctionData(
    functionFragment: "refund(address,address,uint256)",
    values: [
      PromiseOrValue<string>,
      PromiseOrValue<string>,
      PromiseOrValue<BigNumberish>
  ...
  encodeFunctionData(
    ...
    values: [PromiseOrValue<string>[], IInterchainGasEstimation.GasInfoStruct[]]
  ): string;
  encodeFunctionData(
...
export interface GasInfoUpdatedEventObject {
  chain: string;
  info: IInterchainGasEstimation.GasInfoStructOutput;
}
export type GasInfoUpdatedEvent = TypedEvent<
  [string, IInterchainGasEstimation.GasInfoStructOutput],
...
export interface AxelarGasService extends BaseContract {
  ...
  functions: {
    ...
    getGasInfo(
      ...
      overrides?: CallOverrides
    ): Promise<[IInterchainGasEstimation.GasInfoStructOutput]>;
    ...
    updateGasInfo(
      ...
      gasUpdates: IInterchainGasEstimation.GasInfoStruct[],
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
