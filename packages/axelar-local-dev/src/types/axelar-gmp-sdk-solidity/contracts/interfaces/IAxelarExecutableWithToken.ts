...
export interface IAxelarExecutableWithTokenInterface extends utils.Interface {
  functions: {
...
export interface IAxelarExecutableWithToken extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IAxelarExecutableWithTokenInterface;
