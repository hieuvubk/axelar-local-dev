...
export interface IBaseAmplifierGatewayInterface extends utils.Interface {
  functions: {
...
export interface IBaseAmplifierGateway extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IBaseAmplifierGatewayInterface;
