...
export interface InterchainGasEstimationInterface extends utils.Interface {
  functions: {
...
export interface InterchainGasEstimation extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: InterchainGasEstimationInterface;
