...
export interface AxelarValuedExpressExecutableInterface
...
export interface AxelarValuedExpressExecutable extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: AxelarValuedExpressExecutableInterface;
