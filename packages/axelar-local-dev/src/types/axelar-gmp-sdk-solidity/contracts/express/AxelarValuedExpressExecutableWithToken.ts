...
export interface AxelarValuedExpressExecutableWithTokenInterface
...
export interface AxelarValuedExpressExecutableWithToken extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: AxelarValuedExpressExecutableWithTokenInterface;
