...
export interface AxelarExpressExecutableWithTokenInterface
...
export interface AxelarExpressExecutableWithToken extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: AxelarExpressExecutableWithTokenInterface;
