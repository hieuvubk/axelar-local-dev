...
export interface AxelarExecutableWithTokenInterface extends utils.Interface {
  functions: {
...
export interface AxelarExecutableWithToken extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: AxelarExecutableWithTokenInterface;
