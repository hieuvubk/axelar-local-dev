...
import type {
  ...
  IInterchainTokenServiceInterface,
} from "../../../../interchain-token-service/contracts/interfaces/IInterchainTokenService";
...
const _abi = [
  ...
  },
  {
    ...
    outputs: [
      {
        internalType: "address",
        name: "tokenManagerDeployerAddress",
        type: "address",
      },
    ],
    stateMutability: "view",
...
export class IInterchainTokenService__factory {
  static readonly abi = _abi;
  static createInterface(): IInterchainTokenServiceInterface {
    return new utils.Interface(_abi) as IInterchainTokenServiceInterface;
  }
  static connect(
    address: string,
