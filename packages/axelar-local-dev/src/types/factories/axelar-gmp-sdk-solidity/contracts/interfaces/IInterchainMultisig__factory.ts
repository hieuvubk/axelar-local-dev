...
import type {
  IInterchainMultisig,
  IInterchainMultisigInterface,
} from "../../../../axelar-gmp-sdk-solidity/contracts/interfaces/IInterchainMultisig";
...
export class IInterchainMultisig__factory {
  static readonly abi = _abi;
  static createInterface(): IInterchainMultisigInterface {
    return new utils.Interface(_abi) as IInterchainMultisigInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): IInterchainMultisig {
    return new Contract(address, _abi, signerOrProvider) as IInterchainMultisig;
  }
}
